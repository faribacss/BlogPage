...
export default function NotFound() {
  return (
    <div className="h-full bg-gray-100 flex items-center justify-center overflow-hidden py-15">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          ...
          <Link
            to="/"
            className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-gray bg-gray-600 active:bg-gray-600 hover:bg-gray-700"
          >
            back to homepage
          </Link>
        </div>
